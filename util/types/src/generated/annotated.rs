...
impl ::std::fmt::LowerHex for AnnotatedCellInput {
...
impl ::std::fmt::Debug for AnnotatedCellInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::std::fmt::Display for AnnotatedCellInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
...
impl ::std::default::Default for AnnotatedCellInput {
    fn default() -> Self {
        let v: Vec<u8> = vec![
...
impl AnnotatedCellInput {
    ...
    pub fn source(&self) -> RawTransaction {
        ...
        if self.has_extra_fields() {
            ...
            RawTransaction::new_unchecked(self.0.slice_from(start))
        }
    }
...
impl<'r> ::std::fmt::LowerHex for AnnotatedCellInputReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::std::fmt::Debug for AnnotatedCellInputReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::std::fmt::Display for AnnotatedCellInputReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "input", self.input())?;
        write!(f, ", {}: {}", "source", self.source())?;
...
impl ::std::fmt::LowerHex for AnnotatedCellInputVec {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::std::fmt::Debug for AnnotatedCellInputVec {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::std::fmt::Display for AnnotatedCellInputVec {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl ::std::default::Default for AnnotatedCellInputVec {
    fn default() -> Self {
...
impl AnnotatedCellInputVec {
    ...
    pub fn get_unchecked(&self, idx: usize) -> AnnotatedCellInput {
        ...
        if idx == self.len() - 1 {
            AnnotatedCellInput::new_unchecked(self.0.slice_from(start))
        } else {
...
impl<'r> ::std::fmt::LowerHex for AnnotatedCellInputVecReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::std::fmt::Debug for AnnotatedCellInputVecReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::std::fmt::Display for AnnotatedCellInputVecReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl AnnotatedCellInputVecBuilder {
    ...
    pub fn extend<T: ::std::iter::IntoIterator<Item = AnnotatedCellInput>>(
        mut self,
        iter: T,
    ) -> Self {
        for elem in iter {
...
impl ::std::iter::Iterator for AnnotatedCellInputVecIterator {
...
impl ::std::iter::ExactSizeIterator for AnnotatedCellInputVecIterator {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
impl ::std::iter::IntoIterator for AnnotatedCellInputVec {
    type Item = AnnotatedCellInput;
...
impl<'t: 'r, 'r> ::std::iter::Iterator for AnnotatedCellInputVecReaderIterator<'t, 'r> {
...
impl<'t: 'r, 'r> ::std::iter::ExactSizeIterator for AnnotatedCellInputVecReaderIterator<'t, 'r> {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
...
impl ::std::fmt::LowerHex for AnnotatedRawTransaction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::std::fmt::Debug for AnnotatedRawTransaction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::std::fmt::Display for AnnotatedRawTransaction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
...
impl ::std::default::Default for AnnotatedRawTransaction {
    fn default() -> Self {
        let v: Vec<u8> = vec![
...
impl<'r> ::std::fmt::LowerHex for AnnotatedRawTransactionReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::std::fmt::Debug for AnnotatedRawTransactionReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::std::fmt::Display for AnnotatedRawTransactionReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "version", self.version())?;
        write!(f, ", {}: {}", "cell_deps", self.cell_deps())?;
...
impl ::std::fmt::LowerHex for Bip32 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::std::fmt::Debug for Bip32 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::std::fmt::Display for Bip32 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl ::std::default::Default for Bip32 {
    fn default() -> Self {
...
impl<'r> ::std::fmt::LowerHex for Bip32Reader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::std::fmt::Debug for Bip32Reader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::std::fmt::Display for Bip32Reader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl ::std::iter::Iterator for Bip32Iterator {
    type Item = Uint32;
    fn next(&mut self) -> Option<Self::Item> {
        if self.1 >= self.2 {
            None
...
impl ::std::iter::ExactSizeIterator for Bip32Iterator {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
impl ::std::iter::IntoIterator for Bip32 {
    type Item = Uint32;
...
impl<'t: 'r, 'r> ::std::iter::Iterator for Bip32ReaderIterator<'t, 'r> {
...
impl<'t: 'r, 'r> ::std::iter::ExactSizeIterator for Bip32ReaderIterator<'t, 'r> {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
...
impl ::std::fmt::LowerHex for AnnotatedTransaction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::std::fmt::Debug for AnnotatedTransaction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::std::fmt::Display for AnnotatedTransaction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
...
impl ::std::default::Default for AnnotatedTransaction {
    fn default() -> Self {
        let v: Vec<u8> = vec![
...
impl<'r> ::std::fmt::LowerHex for AnnotatedTransactionReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        use molecule::faster_hex::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::std::fmt::Debug for AnnotatedTransactionReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::std::fmt::Display for AnnotatedTransactionReader<'r> {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "signPath", self.sign_path())?;
        write!(f, ", {}: {}", "changePath", self.change_path())?;
